...
public class CollegeWeekLive {
	...
	//public static void main(String[] args) throws Exception {
		...
		driver.findElement(By.name("firstName")).sendKeys("moulika");
		driver.findElement(By.name("lastName")).sendKeys("yammani");
		driver.findElement(By.name("emailAddress")).sendKeys("moulika@gmail.com");
